<template>
    <div class="chartWithOverlay">
        <div class="elasticity-area elasticity-area-simulator" ref="elasticityArea"></div>
        <g-chart
            :data="data"
