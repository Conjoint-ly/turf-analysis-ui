...
<script>
import ScenarioHeaders from '@conjointly/turf-analysis-ui/templates/components/simulations/components/scenario-headers';
import {
...
import MovementsInPreferenceShareChart
  from '@conjointly/turf-analysis-ui/templates/components/simulations/components/movements-in-preference-share-chart';
